...
func TestCleanUrl(t *testing.T) {
	cleanUrlSuccessCases := []struct {
		...
		{"CleanUrl strips trailing slash",
			"https://monzo.com",
			"https://monzo.com/",
			"https://monzo.com",
		},
		{"CleanUrl strips trailing slash with query after slash",
			"https://monzo.com",
			"https://monzo.com/?search=golang_help",
			"https://monzo.com",
		},
	}
	...
	cleanUrlFailureCases := []struct {
		...
		{"pass mailto, throw unsupported protocol error",
			"mailto://josh.laird@monzo.com",
			errUnsupportedProtocol,
		},
	}
